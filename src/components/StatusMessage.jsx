  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 px-6 py-3 w-4/5 rounded ${bgColorClass} text-whitePrimary text-sm flex items-center justify-center gap-4`}
      >
        {type === "loading" && (
