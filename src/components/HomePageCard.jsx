...
function HomePageCard() {
    ...
    return (
        <div className="bg-blackPrimary w-full py-4 flex flex-col gap-4 mt-4 justify-center items-center mb-8">
            <h2 className="font-thin text-whiteSecondary">Popular Destinations</h2>
            <div onClick={() => goToBrowse("Paris")}
                className="relative w-11/12 sm:w-3/4 md:w-2/3 2xl:w-full h-36 sm:h-48 group cursor-pointer duration-300 bottom-0 hover:bottom-0.5"
            >
                <img
