...
const MediaViewer = ({ mediaItems, currentIndex, onClose, onNavigate }) => {
  ...
  return (
    <div className="fixed inset-0 bg-blackPrimary/90 flex justify-center items-center z-50">
      <div className="relative bg-blackSecondary border-1 border-grayPrimary p-2 rounded-lg w-max w-full mx-4">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <img
          ...
          alt="Selected Media"
          className="max-w-full max-h-full object-contain border-1 border-blackPrimary"
